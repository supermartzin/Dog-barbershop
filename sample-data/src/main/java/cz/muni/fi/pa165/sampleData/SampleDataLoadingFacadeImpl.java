...
public class SampleDataLoadingFacadeImpl implements SampleDataLoadingFacade {
    ...
    private Customer customer(String username, String password, String firstName,
                              String lastName, Address address, String email, String phone) throws ServiceException {
    ...
    private Employee employee(String username, String password, String firstName,
                              String lastName, Address address, String email, String phone, BigDecimal salary) throws ServiceException {
        Employee employee = new Employee(username, password, firstName, lastName, address, email, phone, salary);
        employeeService.create(employee);
        return employee;
    }

    private Dog dog(String name, String breed, int age, Customer customer) throws ServiceException {
        Dog dog = new Dog(name, breed, age, customer);
        dogService.create(dog);
        return dog;
    }

    private Service service(String title, int length, BigDecimal price) throws ServiceException {
        Service service = new Service(title, length, price);
        serviceService.create(service);
        return service;
    }

    private Order order(Dog dog, Service service) throws ServiceException {
